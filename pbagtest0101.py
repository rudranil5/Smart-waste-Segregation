...
if __name__=="__main__":
    ...
    testbag(img_path,loadModel())

    #THE CLASSIFICATION MODEL PATHtypeMODEL_PATH = r"E:\DATASET_Trash_sbh_readwrite_ard\garbage-detector\models\final_model_new.keras"
